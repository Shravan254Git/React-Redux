...
// const storeForPizza = createStore(reducerForPizza);
// const storeForBurger = createStore(reducerForBurger);

// // 2 -> It exposes a method called "getState" which gives your application access to the current state in the store.
// console.log("Initial State for Pizza", storeForPizza.getState());
// console.log("Initial State for Burger", storeForBurger.getState());

// // 3 -> Register listener via subscriber(listener)
// const unsubscribePizza = storeForPizza.subscribe(() =>
//   console.log("Udated State for Pizza", storeForPizza.getState())
// );

// const unsubscribeBurger = storeForBurger.subscribe(() =>
//   console.log("Udated State for Burger", storeForBurger.getState())
// );

// // 4 -> Allows state to be updated via dispatch(action)
// console.log('Pizza...');
// storeForPizza.dispatch(orderPizza());
// storeForPizza.dispatch(orderPizza());

// console.log('Burgers...');
// storeForBurger.dispatch(orderBurger());
// storeForBurger.dispatch(orderBurger());
...
const unsubscribe = store.subscribe(() =>
  console.log("Udated State", store.getState())
);
